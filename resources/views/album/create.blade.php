...
<div class="w-full max-w-2xl p-5 pb-10 mx-auto mb-10 mt-5">
    <form action="/addAlbum" method="POST" enctype="multipart/form-data">
        @csrf
        <h1 class="text-4xl font-semibold mb-5 border-b-4 border-gray-500 w-max">Add Album</h1>
        <div class="mb-6">
            ...
            <input type="text" name="namaAlbum" id="small-input"
        ...
        <div class="mb-6">
            <label for="message" class="block mb-2 text-sm font-medium text-gray-900">Deskripsi Album</label>
